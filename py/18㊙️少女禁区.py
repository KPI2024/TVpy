...
# -*- coding: utf-8 -*-
"""
少女禁区 Spider - 四壳通用Python Spider
站点: https://aki.snjq3.yachts/snjq/
"""
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://aki.snjq3.yachts/snjq"
        self.rawUrl = "https://aki.snjq3.yachts/snjq"
        return "少女禁区"
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        for item in items:
            try:
                ...
                img = re.search(r'data-original="([^"]*)"', item).group(1)
