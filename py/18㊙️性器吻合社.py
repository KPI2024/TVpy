...
# -*- coding: utf-8 -*-
"""
性器吻合社 Spider - 四壳通用Python Spider
站点: https://ocn.xqwhs8.makeup/xqwhs/
"""
...
class Spider(Spider):
    def init(self, extend=""):
        self.siteUrl = "https://ocn.xqwhs8.makeup/xqwhs"
        self.rawUrl = "https://ocn.xqwhs8.makeup/xqwhs"
        return "性器吻合社"
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        list = []
        items = re.findall(r'<a href="(/cn/home/web/index.php/vod/play/id/(\d+)/sid/1/nid/1\.html)" title="([^"]*)"', html)
