...
# -*- coding: utf-8 -*-
# 色窝自拍 Spider
# 站点: https://www.swzp4.top/swzp/
# 真实结构: <a href><span><img src></span><h2>标题</h2></a> + player_data.url
...
class Spider(BaseSpider):
    ...
    def init(self, extend=""):
        self.siteUrl = "https://www.swzp4.top"
        self.headers = {
    ...
    def categoryContent(self, tid, pg, filter, extend):
        ...
        # 真实结构: <a href="...vod/play/id/..."><span><img src="..."/></span><h2>标题</h2></a>
        items = re.findall(
            r'<a[^>]*href="([^"]*vod/play/id/[^"]*)"[^>]*>.*?<img[^>]*src="([^"]*)"[^>]*/>.*?<h2[^>]*>([^<]*)</h2>',
            html, re.S
        )
